...
Trex.Attachment.Image = Trex.Class.create({
	...
	getSaveHtml: function(data) {	// title=\"클릭하시면 원본크기로 보실 수 있습니다.\" onclick=\"doImgPop('" + data.imageurl + "')\"  삭제
		return "<img src=\"" + data.imageurl + "\" class=\"txc-image\" style=\"cursor: pointer;\"/>";
	},
	getDispHtml: function(data) {	// title=\"클릭하시면 원본크기로 보실 수 있습니다.\" onclick=\"doImgPop('" + data.imageurl + "')\" 삭제
		return "<img id=\"" + data.dispElId + "\" src=\"" + data.imageurl + "\" class=\"txc-image\" style=\"cursor: pointer;\"/>";
	},
	getDispText: function(data) {	// title=\"클릭하시면 원본크기로 보실 수 있습니다.\" onclick=\"doImgPop('" + data.imageurl + "')\" 삭제
		return "<img src=\"" + data.imageurl + "\" class=\"txc-image\" style=\"cursor: pointer;\"/>";
	},
