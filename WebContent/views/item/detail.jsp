...
<link rel="stylesheet" href="/views/css/item/itemDetail.css" type="text/css">
...
<body>
	...
	<div class="items">
		<div class="item_left">
			<img src="<%=ivo.getFilepath()%>" width="500px" height="650px"
				alt="" /><%=ivo.getPreview()%></div>
			...
			<table border="1" class="itemTable">
				...
				<tr>
					<td>
						...
						<p>
							상품번호<%=ivo.getItem_number()%></p>
					</td>
					<td>
						<h5>Grade</h5>
						<p>
							상품등급<%=ivo.getItem_rating()%></p>
					</td>
				</tr>
				<tr>
					<td colspan="2">
				...
				<tr>
					<td colspan="2">
						<h5>할인된 가격</h5>
						<p>
							상품할인된 가격<%=Parser.disPrice(ivo.getPrice(), ivo.getDiscount())%></p>
					</td>
				</tr>
				<%
				if (ivo.getStok() == 0) {
				...
				<tr>
					<td
						onclick="location.href='/item/shopBasket?item_sq=<%=ivo.getItem_sq()%>'">장바구니</td>
