			...
			<div class="pagination board">
				<%if(filter.equals("1")){ %>
					...
					<div>
						<%if (pagenation.getStartPageNumber() != 1) {%>
							<a class="page_prev" href="/board/notice?pn=<%=pagenation.getStartPageNumber() - 1 %>&filter=<%=filter%>"> << </a>
						<% } %>
					
						<% for (int i = pagenation.getStartPageNumber(); i <= pagenation.getEndPageNumber(); i++) { %>
							<%if (i != Integer.parseInt(pn)) {%>
								<a class="page_num" href="/board/notice?pn=<%=i %>&filter=<%=filter%>"> <%=i%> </a>
							<%} else  {%>
						...
						<%if (pagenation.getTotalPageCount() != pagenation.getEndPageNumber()) {%>
							<a class="page_next" href="/board/notice?pn=<%=pagenation.getEndPageNumber() + 1 %>&filter=<%=filter%>"> >> </a>
						<%} %>
					</div>
				<%} else if(filter.equals("2")||filter.equals("")){ %>
					...
					<%}%>
						...
						<br>
					<%if (pagenation.getStartPageNumber() != 1) {%>
						<a class="page_prev" href="/board/oneAndOneQuestion?pn=<%=pagenation.getStartPageNumber() - 1 %>&filter=<%=filter%>"> << </a>
					<% } %>
				
					<% for (int i = pagenation.getStartPageNumber(); i <= pagenation.getEndPageNumber(); i++) { %>
						<%if (i != Integer.parseInt(pn)) {%>
							<a class="page_num" href="/board/oneAndOneQuestion?pn=<%=i %>&filter=<%=filter%>"> <%=i%> </a>
						<%} else  {%>
							<p class="page_frt"><%=i %></p>
						<%} %>
					<%} %>
					...
					<%if (pagenation.getTotalPageCount() != pagenation.getEndPageNumber()) {%>
						<a class="page_next" href="/board/oneAndOneQuestion?pn=<%=pagenation.getEndPageNumber() + 1 %>&filter=<%=filter%>"> >> </a>
					<%} %>
				...
				<%}else if(filter.equals("3")){ %>
					...
					<%}%>
						...
						<br>
					<%if (pagenation.getStartPageNumber() != 1) {%>
						<a class="page_prev" href="/board/productRelated?pn=<%=pagenation.getStartPageNumber() - 1 %>&filter=<%=filter%>"> << </a>
					<% } %>
				
					<% for (int i = pagenation.getStartPageNumber(); i <= pagenation.getEndPageNumber(); i++) { %>
						<%if (i != Integer.parseInt(pn)) {%>
							<a class="page_num" href="/board/productRelated?pn=<%=i %>&filter=<%=filter%>"> <%=i%> </a>
						<%} else  {%>
							<p class="page_frt"><%=i %></p>
						<%} %>
					<%} %>
					...
					<%if (pagenation.getTotalPageCount() != pagenation.getEndPageNumber()) {%>
						<a class="page_next" href="/board/productRelated?pn=<%=pagenation.getEndPageNumber() + 1 %>&filter=<%=filter%>"> >> </a>
					<%} %>
				...
				<%}else if(filter.equals("4")){ %>
					...
					<%}%>
						...
						<br>
					<%if (pagenation.getStartPageNumber() != 1) {%>
						<a class="page_prev" href="/board/myQuestion?pn=<%=pagenation.getStartPageNumber() - 1 %>&filter=<%=filter%>"> << </a>
					<% } %>
				
					<% for (int i = pagenation.getStartPageNumber(); i <= pagenation.getEndPageNumber(); i++) { %>
						<%if (i != Integer.parseInt(pn)) {%>
							<a class="page_num" href="/board/myQuestion?pn=<%=i %>&filter=<%=filter%>"> <%=i%> </a>
						<%} else  {%>
							<p class="page_frt"><%=i %></p>
						<%} %>
					<%} %>
					...
					<%if (pagenation.getTotalPageCount() != pagenation.getEndPageNumber()) {%>
						<a class="page_next" href="/board/myQuestion?pn=<%=pagenation.getEndPageNumber() + 1 %>&filter=<%=filter%>"> >> </a>
					<%} %>
				<%}%>
			</div>
		</div>
