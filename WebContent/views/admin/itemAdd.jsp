...
<div>
	<div>
		<section>
			<form action="/admin/ItemProcAction.do" method="post" id="reform">
				...
				재고<input type="text" id="stork" name="stork"/><br>
				...
				이미지주소<input type="text" id="imgaddress" name="imgaddress" /><br>
				상품설명<input type="text" id="explanation" name="explanation" /><br>
